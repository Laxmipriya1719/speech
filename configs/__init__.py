...
def get_args():
    ...
    parser.add_argument("-M", "--model_type", help="modify cfg.train.model.type", default='Vesper', type=str)
...
def create_workshop(cfg, local_rank, fold):
    ...
    if local_rank == 0:
        if os.path.exists(cfg.workshop):
            import shutil
            print(f"⚠️ Workshop {cfg.workshop} already exists. Removing...")
