...
# RAVDESS  #
############
_C.ravdess = CN(new_allowed=True)
_C.ravdess.database = 'ravdess'
_C.ravdess.num_classes = 8
_C.ravdess.feature_dir = r"C:\Users\mlaxm\OneDrive\Desktop\right\Vesper\data\ravdess_npy"  # 🛠 Update to your actual .npy folder
_C.ravdess.batch_length = 80000  # Optional: can be adjusted to actual audio duration
_C.ravdess.evaluate = ['accuracy', 'precision', 'recall', 'F1']
_C.ravdess.folds = [1]
_C.ravdess.f1 = 'weighted'
_C.ravdess.have_test_set = False
